...
const ENH = ['enhance-staff.js', 'celebrate.js', 'rewards.js', 'birthday.js', 'training.js', 'games.js', 'hook-rewards.js', 'hook-games.js'].map(f => fs.readFileSync(path.join(H, f), 'utf8')).join('\n');
(async () => {
